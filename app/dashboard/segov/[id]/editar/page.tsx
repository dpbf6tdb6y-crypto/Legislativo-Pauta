...
export default function EditarSeggovPage() {
  ...
  const FASE_DA_CHAVE: Record<string, string> = {
    ...
    // Pautado 2ª/3ª/4ª/5ª vez entra na mesma fase de "Retirado de pauta"
    // (não em "Protocolo") — sempre vem logo depois de uma retirada, então
    // os dois ficam juntos num bloco só em vez de alternar blocos repetidos.
